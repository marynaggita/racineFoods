                ...
                <div class="col-lg-3 col-12">
                    <div class="logo">
                        <a href="<?php echo base_url(); ?>">
                            <img src="<?php echo base_url(); ?>public/uploads/<?php echo $setting['logo']; ?>" style="width: 90px; height: 90px; margin: 0; padding: 0;" alt="Logo">
                        </a>
                    </div>
                </div>
                <div class="col-lg-9 col-12 main-menu">
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            <li><a href="<?php echo base_url(); ?>products"><?php echo PRODUCTS; ?></a></li>
